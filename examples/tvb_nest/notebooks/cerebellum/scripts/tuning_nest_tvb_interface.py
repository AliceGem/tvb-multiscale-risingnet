...
tuned_value_nest_tvb = 100
tuned_value_tvb_nest = 0.8 
COMPUTE_REF = False
...
config.SIMULATION_LENGTH = 250 #20000
...
if COMPUTE_REF:
    ...
    simulator, nest_network = build_tvb_nest_interfaces(simulator, nest_network, nest_nodes_inds, config, max_rate_to_tune=tuned_value_tvb_nest, max_rate_to_tune=tuned_value_nest_tvb)
